module vars
  ...
  real(sp), allocatable :: tdum(:),Rdum(:),Zdum(:),&
   ...
   real(sp), allocatable :: tdum1(:), Rdum1(:),Zdum1(:),&
                             ...
                             psidum1(:),thetadum1(:),&
                             psirdum1(:)
   real(sp), allocatable :: psirdum2(:,:),thetadum2(:,:)
...
!
         ...
         !   a8=cdbbsval(knot(1:nx1),ksp,coefaf(8,1:nx_sp),x,jderivs)
          ...
          if (e==0.0D0) then
            ...
            !rfpr=(a0+a1*cos(t)+a2*cos(2.0*t))/e
          endif
          !if (e==0.0D0) then
          !rfpr=cos(t)
          !else
...
!
        function gtt(t,x)
         ...
         !gtt=(a0+a1*cos(t)+a2*cos(2.0*t))/x**2
...
!
         ...
         !f1=-(a1*cos(t)+2.0*a2*cos(2.0*t))/x**2
