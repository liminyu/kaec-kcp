...
!
         ...
         read(550,*) ! Reading density and beta and q-profile coefficients from the file
         do i=1,nx_cs0-1
            read(550,'(8E16.8)') coefcsden(1:4,i),coefcsbeta(1:4,i)
         enddo
         close(550)
!
         open(unit=560, file='fort.560', status='old')
         read(560,*) ! Reading density and beta and q-profile coefficients from the file
         do i=1,nx_cs0-1
