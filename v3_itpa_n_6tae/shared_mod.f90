...
!       beta=b0*(1.0D0-1.0D0*x**2)
       beta=1.0*(1.0 - 0.95*x**2- 0.05*x**4) ! ITPA n=6
        endfunction beta
!
        function betap(x)
          implicit none
...
!        betap=b0*(-2.0D0*x)
        betap=1.0*( - 2.0*0.95*x- 4.0*0.05*x**3) ! ITPA n=6
        !betap=-6.0D0*(1-x**2)**2*x
        endfunction betap
!
        function betapp(x)
          implicit none
...
!          betapp=b0*((-0.1)*dum1+&
!                 (-0.95-0.1*dum)*dum2)
           betapp=1.0*( - 2.0*0.95- 3.0*4.0*0.05*x**2) ! ITPA n=6
!          betapp=24.0D0*(1-x**2)*x**2-6.0D0*(1-x**2)**2
        endfunction betapp
!
